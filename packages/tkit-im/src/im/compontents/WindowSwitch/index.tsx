...
const WindowSwitch = () => {
  ...
  const rootCls = usePrefixCls('window-switch', 'flex justify-between w-16 p-1.5')
  const btnCls = usePrefixCls('window-switch-btn', 'flex text-center justify-center items-center w-3 h-3 rounded-full')
